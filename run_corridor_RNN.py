...
from src.utils import calculate_collisions, set_params, generate_data, count_parameters
...
ctl = ControllerRNN(sys.f, sys.n, sys.m, n_xi, l, use_sp=use_sp, t_end_sp=t_end, std_ini_param=std_ini_param, stab=False)
